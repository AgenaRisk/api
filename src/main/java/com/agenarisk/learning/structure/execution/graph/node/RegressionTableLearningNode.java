...
/**
 * Graph node for OLS-based table learning: fits continuous nodes' tables directly from data via linear regression,
 * as an alternative to the EM-based {@link ProbabilityLearningNode}. See {@code RegressionTableLearningConfigurer}
 * and {@code RegressionTableLearningExecutor} for the actual learning logic.
 *
 * @author Eugene Dementiev
 */
public class RegressionTableLearningNode extends ModelNode {

	private String model;
	private String dataSource;
	private String missingValue = "";
	private String valueSeparator = ",";
	private String residualMode = RegressionTableLearningConfigurer.RESIDUAL_MODE_NORMAL;
	...
	public String getSubType() {
		return "regressionTableLearning";
	}
	...
	public void parseOptions(JSONObject jOptions) {
		...
		this.residualMode = jOptions.optString("residualMode", RegressionTableLearningConfigurer.RESIDUAL_MODE_NORMAL);
	...
	public void execute(GraphExecutionContext ctx) {
		try {
			...
			if (jResult != null && lastResult != null){
				jResult.put("regressionTableLearning", lastResult);
			}
			setResult(jResult);
			...
			failWith("Regression table learning failed: " + friendlyMessage(ex), ex);
		}
	}
